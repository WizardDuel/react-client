...
/***/ function(module, exports, __webpack_require__) {
	...
	var WizardDuel = React.createClass({
	  ...
	  render: function () {
	    ...
	    var room = React.createElement(WaitingRoom, { enterBattle: this.enterBattle });
	    if (this.state.inBattle) room = React.createElement(BattleRoom, null);
	...
	var WaitingRoom = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "button",
	        { className: "btn btn-default", onClick: this.beginBattle },
	        "Ready to Duel!"
	      )
	    );
	  },
	...
	var BattleRoom = React.createClass({
	  ...
	  render: function () {
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        "button",
	        { className: "btn btn-danger", onClick: this.winBattle },
	        "Win!"
	      )
	    );
	  },
